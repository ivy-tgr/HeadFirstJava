...
class Songs {
	public List<Song> getSongs() {
		return List.of(new Song("$10", "Hitchhiker", "Electronic", 2016, 183),
				...
				new Song("Immigrant P399Songs", "Karen o", "Industrial Rock", 2011, 12),
				new Song("Breathe", "The Prodigy", "Electronie", 1996, 337),
				new Song("What's Going On", "Gaye", "R&B", 1971, 420),
				new Song("Hallucinate", "Dua Lipa", "Pop", 2020, 75),
				new Song("Walk Me Home", "Pink", "Pop", 2019, 459),
